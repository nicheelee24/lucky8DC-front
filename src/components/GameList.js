...
export const GameList = () => {
    ...
    const GAMES_PROVIDERS = {
        ...
        LIVE: ["BG", "HORSEBOOK", "Gamomet","Novomatic","PP", "PT", "SEXYBCRT", "SV388", "VENUS","7Mojos","Evolution","Ezugi","Yolted","WinFast","SAGaming","ThunderKick","BGaming","Blueprint","RedTiger","NetEnt"],
        // LOTTO: ["VRLOTTO"],
        SLOT: [
            "DRAGOONSOFT",
            "FASTSPIN",
